...
<body class="bg-black text-light">
    ...
    <div class="container mt-5 pt-5">
        ...
        <section id="artist-list" class="mb-5">
            ...
            <div class="row">
                <?php
                $stmt = $db->prepare("SELECT DISTINCT Nghe_danh FROM NGHE_SI LIMIT 6;");
                $stmt->execute();
        ...
        <section id="publisher-list" class="mb-5">
            ...
            <div class="row">
                <?php
                $stmt = $db->prepare("SELECT Ten, Ngay_thanh_lap FROM NHA_PHAT_HANH LIMIT 4;");
                $stmt->execute();
                ...
                foreach ($publishers as $publisher) {
                    echo '<div class="col-md-6 mb-3">
                            <div class="card bg-dark text-white shadow">
                                <div class="card-body">
                                    <h5 class="card-title">' . htmlspecialchars($publisher['Ten']) . '</h5>
